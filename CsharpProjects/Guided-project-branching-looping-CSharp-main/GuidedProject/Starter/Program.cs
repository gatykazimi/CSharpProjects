    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            while (anotherPet == "y" && petCount < maxPets)
            {
                ...
                // get a description of the pet's personality - animalPersonality can be blank.
                do
                {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    string currAge = ourAnimals[i, 2].Remove(0, 4);
                    int petAge = 0;
                    if (!int.TryParse(currAge, out petAge))
                    {
                        bool validEntry = false;
                        ...
                        do
                        {
                            ...
                            if (readResult != null)
                            {
                                animalAge = readResult;
                                validEntry = int.TryParse(animalAge, out petAge);
                                if (!validEntry) Console.WriteLine("Please enter an integer");
                            }
                        } while (validEntry == false);
